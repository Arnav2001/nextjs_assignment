...
const TopBar = () => {
  return (
    <div className="bg-white mt-1 p-4 flex items-center border-b border-solid border-gray-200">
      ...
      {/* Center: Search Bar */}
      <div className="flex items-center bg-gray-200 w-96 ml-4 p-2 pl-2 rounded-md">
      ...
      <button className="flex items-center bg-purple-100 text-var(--primary-color) px-4 py-2 rounded-md">
        ...
        <p className="ml-2 font-poppins font-normal text-base leading-6">Invite members</p>
      </button>
